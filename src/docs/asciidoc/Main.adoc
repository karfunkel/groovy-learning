...
Hierbei soll es unerheblich sein ob der Buchstabe gross oder klein geschrieben sien soll.
...
| new      | Instanziierungsoperator. Um aus einer Klasse eine Instanz zu erstellen wird das Schlüsselwort
             ...
             Initialisierungsmethode (Konstruktor) ausgeführt.
                                                                                                | new MyObject()
                                                                                                  new String('Test')
| *.       | Collect-Operator. Wenn der linke Operand z.B. eine Liste ist, wird über diese iteriert
...
Bedingungen können zur zwei Ergebnisse haben: wahr (`true`) oder falsch (`false`). +
